...
class Graph_pricing(BaseCommand):
    ...
    async def handle(self, params, params_optional, message, client):
        ...
        embed.add_field(name="21-day average (WTS):", value="${}".format(round(wts_average_all, 2)), inline=True)
        embed.add_field(name="21-day average (WTB):", value="${}".format(round(wtb_average_all, 2)), inline=True)
